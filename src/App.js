...
const SubCategoryCreate = lazy(() => import("./pages/admin/subCategory/SubCategoryCreate.js"));
const SubCategoryUpdate = lazy(() => import("./pages/admin/subCategory/SubCategoryUpdate.js"));
...
const SubCategoryHome = lazy(() => import("./pages/subCategory/SubCategoryHome.js"));
  ...
  return (
    <Suspense fallback={
      ...
      <Switch>
        ...
        <Route exact path="/subcategory/:slug" component={SubCategoryHome}></Route>
        ...
        <AdminRoute exact path="/admin/subcategory" component={SubCategoryCreate}></AdminRoute>
